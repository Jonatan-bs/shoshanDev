        ...
        <Container pb={3}>
            ...
            <ServiceGrid>
                <ServiceCard> 
                    ...
                    <Heading as="h4" py={.2} size="sm" caps>Hjemmeside</Heading>
                    <Text>
                        Responsive<br/>
                        UX<br/>
                        Wordress<br/>
                ...
                <ServiceCard> 
                    ...
                    <Heading as="h4" py={.2} size="sm" caps>Webshop</Heading>
                    <Text>
                        Responsive<br/>
                        UX<br/>
                        Wordress<br/>
                ...
                <ServiceCard> 
                    ...
                    <Heading as="h4" py={.2} size="sm" caps>Web app</Heading>
                    <Text>
                        Responsive<br/>
                        UX<br/>
                        Wordress<br/>
                ...
                <ServiceCard> 
                    ...
                    <Heading as="h4" py={.2} size="sm" caps>Support</Heading>
                    <Text>
                        Responsive<br/>
                        UX<br/>
                        Wordress<br/>
